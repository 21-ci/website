...
/**
 * Physics lanyard card (reactbits.dev/components/lanyard, MIT).
 * A draggable ID badge hanging on a rope, simulated with rapier.
 */
...
import { useBadgeTexture } from "./useBadgeTexture";
...
function Band({
  ...
  useRopeJoint(fixed as any, j1, [[0, 0, 0], [0, 0, 0], 0.7]);
